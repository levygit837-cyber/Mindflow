...
from omnimind_backend.grpc.config.dynamic.validator import ValidationResult
from omnimind_backend.grpc.config.features import FeatureToggles, get_feature_toggles, FeatureEvaluationContext
from omnimind_backend.grpc.config.profiles import EnvironmentLoader, get_environment_loader
...
async def update_feature_flag(
    ...
    try:
        ...
        if request.enabled is not None:
            from omnimind_backend.grpc.config.features import FeatureState

"""Base chain classes for OmniMind orchestration."""
...
from omnimind_backend.chains.base.step import ChainStep, StepResult, StepStatus, StepMetrics
...
class BaseChain(ABC):
    """Abstract base class for all chains in OmniMind."""

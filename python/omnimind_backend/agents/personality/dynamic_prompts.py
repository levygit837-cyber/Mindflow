"""Dynamic prompt system for OmniMind agents.
...
from omnimind_backend.schemas.orchestration.personality import PersonalityType, TaskComplexity
...
class DynamicPromptBuilder:
    ...
    def _build_personality_section(self, context: PromptContext) -> str:
        ...
        if sub_personality:
            from omnimind_backend.agents.personality.sub_personalities import get_sub_personality
    ...
    def _get_base_preamble(self) -> str:
        ...
        return """You are OmniMind, an advanced AI assistant designed to help with a wide range of tasks.

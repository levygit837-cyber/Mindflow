...
from omnimind_backend.graphs.base.graph import BaseGraph
from omnimind_backend.graphs.base.types import GraphConfig, GraphType
from omnimind_backend.graphs.orchestrator.simple_flow import SimpleOrchestratorGraph
...
def build_simple_orchestrator_flow() -> Any:
    ...
    from omnimind_backend.graphs.orchestrator.simple_flow import build_simple_orchestrator_flow as _build

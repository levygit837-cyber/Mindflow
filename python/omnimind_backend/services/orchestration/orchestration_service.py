...
from omnimind_backend.services.interfaces.orchestration_interfaces import OrchestrationServiceInterface
...
class OrchestrationService(BaseAbstractService, OrchestrationServiceInterface):
    ...
    def _get_task_service(self):
        ...
        if self._task_service is None:
            from omnimind_backend.services import get_task_service

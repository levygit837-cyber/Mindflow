...
from omnimind_backend.schemas.session.contracts import (
    RetrievalMode,
    RetrievedContext,
    SessionRetriever,
)
from omnimind_backend.services.interfaces.base_interfaces import BaseAbstractService
from omnimind_backend.services.interfaces.context_interfaces import RetrievalServiceInterface
...
class RetrievalService(BaseAbstractService, RetrievalServiceInterface):
    ...
    def _get_vector_service(self):
        ...
        if self._vector_service is None:
            from omnimind_backend.services import get_vector_service
    ...
    def _get_embedding_service(self):
        ...
        if self._embedding_service is None:
            from omnimind_backend.services import get_embedding_service

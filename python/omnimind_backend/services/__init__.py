"""OmniMind Backend Services.

This module provides a unified interface for all business services
in the OmniMind backend, organized by domain and functionality.
...
from omnimind_backend.services.context import (
...
from omnimind_backend.services.monitoring import (
    get_health_service,
    get_metrics_service,
    get_review_service,
)
...
from omnimind_backend.services.communication import (
    get_grpc_service,
    get_streaming_service,
)

# Dependency injection container
from omnimind_backend.services.core.container import (
    get_container,
    get_service,
    register_service,
...
# Service interfaces
from omnimind_backend.services.interfaces import (

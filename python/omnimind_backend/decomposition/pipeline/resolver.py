...
from omnimind_backend.decomposition.engine import TaskResolver
...
from omnimind_backend.schemas.orchestration.orchestrator import SandboxMode
...
if TYPE_CHECKING:
    from omnimind_backend.orchestrator.semantic_context_manager import ContextMatch
...
class ContextAwareResolver(TaskResolver):
    ...
    async def _ensure_initialized(self) -> None:
        if self._initialized:
            return
        from omnimind_backend.orchestrator.semantic_context_manager import get_semantic_context_manager  # noqa: PLC0415

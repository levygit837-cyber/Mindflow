    ...
    async def _handle_context_summarization(self, message_data: Dict[str, Any]) -> WorkerResult:
        ...
        return WorkerResult(
            ...
            data={
                ...
                "summary_text": "Session focused on implementing a multi-agent system with RabbitMQ workers for background processing. Key achievements include hierarchical worker structure, specialized agents, and integration with existing OmniMind architecture.",
                "key_points": [
        ...
        return WorkerResult(
            ...
            data={
                ...
                "consolidation_summary": {
                    ...
                    "key_entities": ["OmniMind", "RabbitMQ", "agents"],

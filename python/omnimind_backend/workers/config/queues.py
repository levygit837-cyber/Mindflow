"""RabbitMQ queue configuration for OmniMind workers."""
...
class QueueConfig:
    ...
    def get_full_queue_name(self) -> str:
        ...
        return f"omnimind.{self.domain.value}.{self.worker_type}.{self.priority.value}"
...
class QueueDefinitions:
    """Predefined queue configurations for OmniMind."""

...
from omnimind_backend.agents.context.vector_store import get_vector_store
from omnimind_backend.agents.core.interfaces import VectorStore
from omnimind_backend.infra.config import get_settings
from omnimind_backend.infra.logging import get_logger
from omnimind_backend.services.multilingual_embeddings import get_multilingual_embedding_service
...
class SemanticContextManager:
    ...
    async def register_main_task(
        ...
        """
        from omnimind_backend.schemas.orchestration.decomposition.decomposition_v2 import (  # noqa: PLC0415
            MainTaskSummary,
            SubTaskSummary,
        )

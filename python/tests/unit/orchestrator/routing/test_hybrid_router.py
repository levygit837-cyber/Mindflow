...
class TestHybridRouterTier1Direct:
    ...
    @pytest.mark.asyncio
    async def test_direct_response_strategy_normalizes_to_orchestrator_delegate(self, router) -> None:
        """Legacy DIRECT_RESPONSE intent now delegates back to the orchestrator."""
        intent = _make_intent(
            confidence=0.95,

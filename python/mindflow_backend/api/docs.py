...
def custom_openapi(app: FastAPI) -> Dict[str, Any]:
    ...
    openapi_schema = get_openapi(
        ...
        ## Overview
        The MindFlow API provides a comprehensive interface for managing AI agents, sessions, orchestration, providers, and memory operations.
        ...
        servers=[
            ...
            {"url": "https://api.mindflow.ai", "description": "Production server"},
        ],
        contact={
            "name": "MindFlow Team",
            "email": "api@mindflow.ai",
    ...
    openapi_schema["components"]["examples"] = {
        ...
        "SessionCreateRequest": {
            ...
            "value": {
                ...
                "user_id": "user-12345",
                "metadata": {"project": "mindflow", "type": "security"}
            }
        },
                    ...
                    "content": {
                        "application/json": {
                            ...
                            "example": {
                                ...
                                "user_id": "user-12345",
                                "metadata": {"project": "mindflow", "type": "review"}
                            }
                        }
                    },
                    "required": True

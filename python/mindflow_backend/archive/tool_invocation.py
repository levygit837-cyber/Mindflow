...
warnings.warn(
    "tool_invocation module is deprecated. "
...
async def invoke_with_tools(
    ...
    *,
    ...
    while True:
        ...
        # Use StreamingToolExecutor for tool execution (unified executor)
        from mindflow_backend.runtime.execution.streaming_executor import (
            StreamingToolExecutor,
            ToolDefinition,
            ToolUseContext,
        )
        from mindflow_backend.runtime.execution.callable_adapter import callable_tools_to_definitions

        # Convert LangChain tools to ToolDefinitions if needed
        # For now, create a simple wrapper that calls ainvoke
        ...
        # Create can_use_tool function (always allow for now)

...
from .contracts import ContextWindow, MemoryCursor, MemoryEntry
...
class BaseMemoryResponse(BaseModel):
    ...
    operation_id: UUID | None = Field(default=None, description="Operation identifier")
...
class MemoryStoreResponse(BaseMemoryResponse):
    ...
    embedding_dimension: int | None = Field(default=None, description="Embedding dimension if generated")
...
class MemorySearchResponse(BaseMemoryResponse):
    ...
    session_id: UUID | None = Field(default=None, description="Session ID if filtered")
...
class SearchResult(BaseModel):
    ...
    highlights: list[str] | None = Field(default=None, description="Highlighted matches")
...
class MemoryStatsResponse(BaseMemoryResponse):
    ...
    storage_size_bytes: int | None = Field(default=None, description="Storage size in bytes")
    ...
    average_retrieval_time_ms: float | None = Field(default=None, description="Average retrieval time")
...
class MemoryExportResponse(BaseMemoryResponse):
    ...
    expires_at: datetime | None = Field(default=None, description="Export expiration time")
    processing_time_ms: int | None = Field(default=None, description="Processing time in milliseconds")
...
class MemoryBatchResponse(BaseMemoryResponse):
    ...
    processing_time_ms: int | None = Field(default=None, description="Total processing time")
...
class MemoryHealthResponse(BaseMemoryResponse):
    ...
    available_space_bytes: int | None = Field(default=None, description="Available storage space")
    storage_utilization: float | None = Field(default=None, description="Storage utilization percentage")
    
    # Performance health
    response_time_ms: float | None = Field(default=None, description="Average response time")

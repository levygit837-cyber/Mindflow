...
from mindflow_backend.grpc_internal.interfaces.server import GrpcServer
from mindflow_backend.grpc_internal.monitoring.health import AdvancedHealthChecker
from mindflow_backend.grpc_internal.monitoring.interceptor import MetricsInterceptor
...
class EnhancedGrpcAgentServer(GrpcServer):
    ...
    async def _setup_services(self) -> None:
        """Setup gRPC services."""
        try:
            from mindflow_backend.grpc_internal.generated import (

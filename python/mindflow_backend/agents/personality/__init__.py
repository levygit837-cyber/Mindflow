"""Personality system for MindFlow agents.
...
from mindflow_backend.agents.personality.selector import get_personality_selector
from mindflow_backend.agents.personality.configuration import (
    get_personality_config_builder,
    get_delegation_task_builder,
)
from mindflow_backend.agents.personality.rule_engine import get_personality_rule_engine

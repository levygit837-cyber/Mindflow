...
from mindflow_backend.agents.prompts.specialized.agent_delegation import AGENT_DELEGATION_PROMPT
from mindflow_backend.agents.prompts.specialized.architecture_review import (
    ARCHITECTURE_REVIEW_PROMPT,
)
from mindflow_backend.agents.prompts.specialized.brainstorming import BRAINSTORMING_PROMPT

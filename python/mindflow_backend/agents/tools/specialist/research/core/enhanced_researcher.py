...
from mindflow_backend.agents.tools.specialist.research.core.enhanced_query_planner import get_enhanced_query_planner
from mindflow_backend.agents.tools.specialist.research.analysis.result_synthesizer import get_result_synthesizer
from mindflow_backend.agents.tools.specialist.research.analysis.source_trust_engine import get_source_trust_engine
from mindflow_backend.agents.tools.browser_search import get_browser_search_tool
...
class EnhancedResearcherAgent:
    ...
    async def execute_simple_search(self, query: str) -> ResearchResponse:
        ...
        from mindflow_backend.schemas.agents.research import QueryIntent, QuestionType

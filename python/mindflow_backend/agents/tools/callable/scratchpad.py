"""Scratchpad Tools - Callable pattern.
...
class ScratchpadReadInput(BaseModel):
    """Input schema for ScratchpadReadCallable."""
...
async def scratchpad_read_impl(
    input: ScratchpadReadInput,
    context: ToolContext,
    ...
    try:
        ...
        if not file_path.exists():
            return CallableToolResult(
                ...
                success=True,
                metadata={"operation": "read_scratchpad"}
            )
        ...
        return CallableToolResult(
            ...
            metadata={"error_code": "SCRATCHPAD_READ_ERROR"}
        )


ScratchpadReadCallable = build_readonly_tool(
...
class ScratchpadWriteInput(BaseModel):
    """Input schema for ScratchpadWriteCallable."""
...
async def scratchpad_write_impl(
    ...
    try:
        ...
        return CallableToolResult(
            ...
            success=True,
            metadata={"operation": "write_scratchpad"}
        )
        ...
        return CallableToolResult(
            ...
            metadata={"error_code": "SCRATCHPAD_WRITE_ERROR"}
        )


ScratchpadWriteCallable = build_callable_tool(

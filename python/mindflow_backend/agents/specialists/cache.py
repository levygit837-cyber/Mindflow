"""Cache implementation for specialist selection.

Provides caching for specialist decisions to improve
...
class SpecialistCache:
    """Specialized cache for specialist selection operations."""
    
    def __init__(self, cache_impl: Cache | None = None):
        self.cache = cache_impl or LRUSpecialistCache()
        self.key_prefix = "specialist:"
    
    def get_decision(
        self,
        task_signature: str,
    ) -> Any | None:
        """Get cached specialist decision for task signature."""
    ...
    def set_decision(
        ...
        """Cache specialist decision for task signature."""
        key = self._generate_key(task_signature)
...
class LRUSpecialistCache(Cache):
    """Thread-safe LRU cache for specialist decisions."""
...
_specialist_cache: LRUSpecialistCache | None = None

def get_specialist_cache() -> LRUSpecialistCache:
    """Get the global specialist cache instance."""
    global _specialist_cache
    if _specialist_cache is None:
        _specialist_cache = LRUSpecialistCache()

            ...
            data={
                ...
                "processing_results": {
                    ...
                    "linguistic_analysis": {
                        ...
                        "named_entities": ["MindFlow", "RabbitMQ", "Python"],
                        "sentiment": {
                            "polarity": 0.15,
                            "subjectivity": 0.65,
    ...
    async def _handle_summarization(self, message_data: Dict[str, Any]) -> WorkerResult:
        ...
        return WorkerResult(
            ...
            data={
                ...
                "summary_content": "Implementation of hierarchical RabbitMQ workers for MindFlow system, featuring specialized agents, system tasks, and research capabilities with improved scalability and performance.",
                "summary_statistics": {
